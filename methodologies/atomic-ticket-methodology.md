...
| 類型 | 代碼 | 用途 | 範例 |
|------|------|------|------|
| Research | RES | 探索未知領域 | 調查新技術可行性 |
| Analysis | ANA | 理解現狀和問題 | 分析測試失敗根因 |
| Evaluation | EVA | 比較方案和風險 | 評估重構方案 |
| Implementation | IMP | 執行具體任務 | 實作新功能 |
| Investigation | INV | 深入追蹤問題根因 | 追查效能瓶頸 |
| Documentation | DOC | 記錄和傳承經驗 | 整合方法論 |
