...
**Last Updated**: 2026-07-20 | **Version**: 1.3.0 — 新增規則 6「驗證器警告與工具自動產出衝突時先查建立端定義」，含可操作判定表；規則 5 補交叉引用。歷史 1.0–1.2 版見 git log。**Source**: confabulation 根因 ANA（四視角整合）；PC-166；PC-BAL-001。
