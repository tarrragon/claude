...
def main() -> None:
    ...
    # 文件編寫任務和基礎設施任務不需要這些檢查
    if not is_infrastructure_task and not is_documentation_task:
    ...
    # 5.3 架構規範引用檢查（文件編寫任務不需要）
    if not is_documentation_task:
