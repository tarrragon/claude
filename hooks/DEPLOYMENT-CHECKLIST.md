...
- [x] `.claude/hooks/TECH-DEBT-REMINDER-QUICK-REF.md` (4 KB)
- [x] `.claude/hooks/TECH-DEBT-REMINDER-USAGE.md` (6 KB)
- [x] `.claude/hooks/README-TECH-DEBT-REMINDER.md` (2 KB)
- [x] `.claude/hooks/IMPLEMENTATION-SUMMARY.md` (12 KB)
