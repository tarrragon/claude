...
### 3. 完整文件
**檔案**: `.claude/hooks/L10N_SYNC_VERIFICATION_README.md`
- 大小: 10.6 KB
- 內容: 完整的設計文件、使用指引、故障排除
- 場景涵蓋: 所有使用情況和常見問題

### 4. 快速參考
**檔案**: `.claude/hooks/L10N_QUICK_REFERENCE.md`
- 大小: 3.4 KB
- 內容: 簡化版本，包含修復步驟和常見問題
...
- 完整文件: `.claude/hooks/L10N_SYNC_VERIFICATION_README.md`
- 快速參考: `.claude/hooks/L10N_QUICK_REFERENCE.md`
