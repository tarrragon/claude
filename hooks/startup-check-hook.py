...
def setup_logging():
    ...
    log_file = log_dir / "startup-check-hook-${timestamp}.log"
...
def main():
    ...
    log_message("[START] startup-check-hook: 開始執行", log_file)
    
    # TODO: Implement script logic here
    
    log_message("[OK] startup-check-hook: 執行完成", log_file)
    return 0
