...
> 核心決策規則請見：@.claude/rules/flows/ticket-lifecycle.md
...
> 詳細流程：@.claude/rules/flows/tdd-flow.md
...
> 詳細流程：@.claude/rules/flows/tech-debt.md
...
- v4.0.0 (2026-02-06): 瘦身重構 - 移出至 details 參考文件
  ...
  - 精簡版保留核心決策規則
  - 本文件作為詳細參考
- v3.1.0 (2026-02-03): 統一驗收派發規則，移除 PM 直接驗收（W4-052.5）
- v3.0.0 (2026-02-03): 將驗收流程從 complete 之後改為 complete 之前（W4-052.3）
- v2.9.0 (2026-02-03): 新增執行日誌驗證機制（W4-051）
- v2.8.0 (2026-02-01): 取消驗收豁免機制，改為契約式驗收（W4-034.2）
- v2.7.0 (2026-02-01): 強化驗收代理人派發要求（W4-031.3）
